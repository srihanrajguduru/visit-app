        ...
        <div className="animated-gradient min-h-screen flex items-center justify-center p-4">
            ...
            >
                ...
                <p className="text-gray-400 text-center text-sm mb-8">
                    Start exploring Hyderabad livability scores
                </p>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="btn-glow w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold disabled:opacity-50"
                    >
